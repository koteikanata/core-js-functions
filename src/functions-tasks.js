...
function getCurrentFunctionName() {
  return getCurrentFunctionName.prototype.constructor.name;
}
...
function logger(func, logFunc) {
  return (...args) => {
    const name = func.name || 'anonymous function';
    const argString = args.map((arg) => JSON.stringify(arg));
